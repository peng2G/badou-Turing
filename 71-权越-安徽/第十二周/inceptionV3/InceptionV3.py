...
def InceptionV3(input_shape=[299,299,3],classes=1000):
    ...
    # Block part1
    # 35*35*192 ->35*35*256
    branch11x1=conv2d_bn(x,64,1,1)

    branch15x5=conv2d_bn(x,48,1,1)
    branch15x5=conv2d_bn(branch15x5,64,5,5)
    ...
    # 64+64+96+32=256
    x=layers.concatenate([branch11x1,branch15x5,branch3x3db1,branch_pool],axis=3,name='mixed0')
    ...
    x=layers.concatenate([branch3x3,branch3x3db1,branch_pool],axis=3,
                         name='mixed3')
    ...
    x=layers.concatenate(
        [branch1x1,branch7x7,branch7x7db1,branch_pool],axis=3,name='mixed4'
    )
